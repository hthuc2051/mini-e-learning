...
namespace OnlineStudyWebAdmin.Controllers
{
    public class tblUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,username,password,role,active")] tblUser tblUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,username,password,role,active")] tblUser tblUser)
        {
            if (ModelState.IsValid)
            {
